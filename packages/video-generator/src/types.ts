...
export interface VideoModel {
  ...
  /** Display name */
  name: string;
  /** Model brand logo/icon URL or single character (e.g., "https://example.com/logo.png" or "P") - optional */
  icon?: string;
  ...
  /**
   * Quality-duration constraints for models like sora-2-pro.
  ...
  /**
   * Reference video constraints for models that accept video input (e.g., wan2.6-reference-video).
   */
