...
export function VideoGeneratorInput({
  ...
  const calculatedCredits = useMemo(() => {
    ...
    return 0;
  }, [calculateCredits, estimatedCredits, currentModel, generationType, currentOutputNumber, duration, resolution]);
  ...
  return (
    <div className={cn("w-full max-w-4xl mx-auto", className)}>
      ...
      {/* Main Input Card */}
      <div className="rounded-2xl bg-zinc-900/90 backdrop-blur-sm border border-zinc-800 overflow-hidden">
        {/* Input Area */}
