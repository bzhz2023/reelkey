...
export const DEFAULT_VIDEO_MODELS: VideoModel[] = [
  ...
  },
  {
    ...
    icon: "https://videocdn.pollo.ai/web-cdn/pollo/test/cm3pol28q0000ojuuyeo77e36/image/1759998830447-10c6484e-786d-4d05-a2c4-f0c929b1042b.svg",
    color: "#10a37f",
    description: "Sora 2 preview with flexible duration options",
    maxDuration: "12 sec",
    creditCost: 5,
    // API: duration supports 4, 8, 12 sec
    durations: ["4s", "8s", "12s"],
    // API: aspect_ratio supports 1280x720, 720x1280
    aspectRatios: ["16:9", "9:16"],
    // API: resolution 1280x720 (720P) or 720x1280
    resolutions: ["720P"],
    // API: max 1 image
    maxImages: 1,
  },
  {
    ...
    icon: "https://videocdn.pollo.ai/web-cdn/pollo/test/cm3pol28q0000ojuuyeo77e36/image/1759998830447-10c6484e-786d-4d05-a2c4-f0c929b1042b.svg",
    color: "#000000",
    description: "Professional Sora 2 with longer video support",
    maxDuration: "25 sec",
    creditCost: 15,
    // API: duration supports 15, 25 sec
    durations: ["15s", "25s"],
    // API: aspect_ratio supports 16:9, 9:16
    aspectRatios: ["16:9", "9:16"],
    // API: max 1 image
    maxImages: 1,
    // API: quality linked to duration
    qualities: ["standard", "high"],
    qualityDurationConstraints: {
      "15s": ["high"],     // 15s only supports high quality
      "25s": ["standard"], // 25s only supports standard quality
    },
  },
  ...
  // ============================================================================
  {
    ...
    maxDuration: "15 sec",
    creditCost: 6,
    // API: duration supports 5, 10, 15 sec
    durations: ["5s", "10s", "15s"],
    // API: aspect_ratio supports 16:9, 9:16, 1:1, 4:3, 3:4
    aspectRatios: ["16:9", "9:16", "1:1", "4:3", "3:4"],
    // API: 720p/1080p
    resolutions: ["720P", "1080P"],
    // Optional image input (text-only or with image)
    maxImages: 1,
  ...
  },
  {
    ...
    icon: "https://videocdn.pollo.ai/model-icon/svg/Group.svg",
    color: "#ff6a00",
    description: "Video generation from reference videos",
    maxDuration: "10 sec",
    creditCost: 8,
    // API: duration supports 5, 10 sec
    durations: ["5s", "10s"],
    // API: aspect_ratio supports 16:9, 9:16, 1:1, 4:3, 3:4
    aspectRatios: ["16:9", "9:16", "1:1", "4:3", "3:4"],
    // API: 720p/1080p
    resolutions: ["720P", "1080P"],
    // Accepts video input instead of images
    acceptsVideoInput: true,
    maxImages: 0,
  ...
  },
  {
    ...
    icon: "https://videocdn.pollo.ai/web-cdn/pollo/production/cm3po9yyf0003oh0c2iyt8ajy/image/1753259785486-de7c53b0-9576-4d3e-a76a-a94fcac57bf1.svg",
    color: "#4285f4",
    description: "Google's professional video generation with reference support",
    maxDuration: "8 sec",
    creditCost: 12,
    // API: duration supports 4, 6, 8 sec (REFERENCE mode fixed 8s)
    durations: ["4s", "6s", "8s"],
    // API: aspect_ratio supports 16:9, 9:16 (REFERENCE mode only 16:9)
    aspectRatios: ["16:9", "9:16"],
    // API: 720p/1080p
    resolutions: ["720P", "1080P"],
    // API: supports TEXT, FIRST&LAST, REFERENCE modes, max 3 images
    maxImages: 3,
    // API: n=1~4
    outputNumbers: [
      { value: 1 },
    ...
    hint: "REFERENCE mode: 16:9 ratio, 8s fixed",
  },
...
export const DEFAULT_VIDEO_MODES: GeneratorMode[] = [
  {
    ...
    // Sora series, Wan, Veo series (TEXT mode), Seedance
    supportedModels: [
      "sora-2",
      "sora-2-preview",
      "sora-2-pro",
  ...
  },
  {
    ...
    supportedModels: ["veo-3.1-fast-preview", "veo-3.1-preview", "seedance-1.5-pro"],
    aspectRatios: ["16:9", "9:16"],
  },
  {
    ...
    supportedModels: ["veo-3.1-preview", "wan2.6-reference-video"],
...
// sora-2: 10s, 15s
// sora-2-preview: 4s, 8s, 12s
// sora-2-pro: 15s, 25s
// veo3.1 series: various durations
export const DEFAULT_DURATIONS = ["4s", "8s", "10s", "12s", "15s", "25s"];
