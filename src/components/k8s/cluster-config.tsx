...
import { updateClusterAction } from "@/actions/k8s";
...
export function ClusterConfig({ cluster, params: { lang } }: ClusterProps) {
  ...
  const { executeAsync, status } = useAction(updateClusterAction);
  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    return toast.success("Your cluster config has been saved.");
  }
